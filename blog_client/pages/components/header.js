  ...
  <div className={styles.header}>
    <Row type="flex" justify="center">
        <Col push="2" xs={12} sm={12} md={12} lg={12} xl={12}>
            <Link href='/'><span className={styles.header_logo}>BLOG</span></Link>
        ...
        <Col push="1" className={styles.menu_div} xs={12} sm={12} md={12} lg={12} xl={10}>
            <Menu  mode="horizontal">
                ...
                <Menu.Item key="Online_resources">
                    <Link href={{ pathname: '/list', query: { id: 1,type:'专业技能' } }}><span>
                        {/* <HomeOutlined/> */}
                    专业技能</span></Link>
                </Menu.Item>
                <Menu.Item key="video">
                    {/* <Icon type="youtube" /> */}
                   <Link href={{ pathname: '/list', query: { id: 2,type:'生活记录'} }}><span>
                       {/* <ReadOutlined /> */}
                       生活记录</span></Link>
                </Menu.Item>
                <Menu.Item key="life">
